...
// var testxct = require('./controllers/Cryptochats/testXct');
 ...
 var Ethescrow = require('./Eth_escrow');
// var testescrow_USDT = require('./controllers/Escrow/Escrow_USDT ');
...
// app.use('/api/testusdt', testusdt);
  app.use('/api/escrow', Ethescrow);
//  app.use('/api/escrow_usdt', testescrow_USDT);
